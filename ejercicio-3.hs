...
cuentaBizarra (tupla1, tupla2) | tupla1 > tupla2 = tupla1+tupla2
                               | segundoLlevaMasDe10 (tupla1, tupla2) = tupla2 - tupla1
							   | otherwise = tupla1 * tupla2		   

segundoLlevaMasDe10 (tupla1, tupla2) = (tupla2 - tupla1) > 10